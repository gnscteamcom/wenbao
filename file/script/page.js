...
///////////////////
function setModule1(i, n) {Dd('destoon_search').action = DTPath+'auction/search.php';Dd('destoon_moduleid').value = i;searchid = i;Dd('destoon_select').value = n;$('#search_module').fadeOut('fast');Dd('destoon_kw').focus();}
///////////////////
