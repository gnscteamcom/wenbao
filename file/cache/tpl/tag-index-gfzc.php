...
$listArr[] = $row; 
 ...
 ?>
<?php if(is_array($listArr)) { foreach($listArr as $k => $v) { ?>
<?php if($v['name']) { ?>
<li>
<table width="718" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="217" height="28"><a href="<?php echo $v['linkurl']; ?>"><?php echo dsubstr($v['typename'], 36, '...');?></a></td>
    <td width="111"><?php echo $v['name'];?></td>
    <td width="101">￥<?php echo $v['price'];?></td>
    <td width="158"><?php echo timetodate($v['fromtime'], $datetype);?> 开拍</td>
    <td width="131">出价<?php echo $v['hits'];?>次 </td>
  </tr>
</table>
</li>
<?php } ?>
