...
<div class="warn">贵古玩家尚未完善详细资料！完善的商业信息有助于获得别人的信任，结交潜在的商业伙伴，获取商业机会，请尽快完善</div>
<?php } ?>
...
<?php if($is_company) { ?>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="Tab2"><a href="javascript:Tab(2);"><span>古玩家资料</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="Tab3"><a href="javascript:Tab(3);"><span>古玩家联系方式</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="Tab4"><a href="javascript:Tab(4);"><span>古玩家介绍</span></a></td>
<?php } ?>
</tr>
</table>
</div>
...
<tr>
<td class="tl"><span class="f_red">*</span>古玩家类型</td>
...
<tr>
<td class="tl"><span class="f_red">*</span>古玩家从事年份</td>
...
<tr>
<td class="tl"><span class="f_red">*</span>古玩家地址</td>
...
<tr>
<td class="tl"><span class="f_red">*</span>古玩家介绍</td>
...
if(Dd('areaid_1').value == 0) {
Tab(2);
Dmsg('请选择古玩家所在地', 'areaid');
return false;
}
if(Dd('catid').value.length < 2) {
Tab(2);
Dmsg('请选择古玩家主营行业', 'catid');
return false;
}
...
Tab(2);
Dmsg('请填写古玩家从事年份', 'regyear');
return false;
}
if(Dd('daddress').value.length < 5) {
Tab(3);
Dmsg('请填写古玩家地址', 'daddress');
return false;
}
if(Dd('telephone').value.length < 6) {
Tab(3);
Dmsg('请填写古玩家电话', 'telephone');
return false;
}
if(FCKLen('introduce') < 10) {
Tab(4);
Dmsg('古玩家介绍不能少于10字，当前已经输入'+FCKLen('introduce')+'字', 'introduce');
return false;
}
<?php } ?>
return true;
