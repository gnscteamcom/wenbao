...
<?php if($DT['sms'] && $COM['vmobile']) { ?>&nbsp;&nbsp;<a href="<?php echo $MODULE['2']['linkurl'];?>sms.php?action=add&auth=<?php echo encrypt($COM['mobile']);?>" target="_blank"><img src="<?php echo DT_SKIN;?>image/sendsms.gif" align="absmiddle" title="发送短信" alt=""/></a><?php } ?>
</td>
</tr>
<?php } ?>
<tr>
...
<?php if($COM['msn'] && $DT['im_msn']) { ?><?php echo im_msn($COM['msn']);?>&nbsp;<?php } ?>
