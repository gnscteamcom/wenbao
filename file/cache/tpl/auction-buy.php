...
<td height="35"><a href="<?php echo $item['linkurl'];?>" target="_blank"><img src="<?php echo $item['thumb'];?>" width="50" alt="<?php echo $item['title'];?>"  onerror="this.src=errimg;"/></a></td>
<td height="35" align="left"><a href="<?php echo $item['linkurl'];?>" target="_blank" class="px13 f_b"><?php echo $item['title'];?></a>
...
<td height="35"><span class="f_price" id="price_<?php echo $itemid;?>"><?php echo $item['auction_price'];?></span></td>
...
<td height="35"><span class="f_price" id="total_<?php echo $itemid;?>"><?php echo $item['auction_price'];?></span></td>
</tr>
</table>
<div class="b10">&nbsp;</div>
<div style="border-top:#CCCCCC 1px solid;background:#F6F6F6;padding:20px 40px 20px 0;color:#666666;text-align:right;">
<?php $yongjin=$item['auction_price']*0.035;?>
<?php $yongjin=number_format($yongjin,1);?>
<?php if($yongjin>4000) { ?>
<?php $yongjin=4000;?>
<?php } ?>
<?php $totol=$yongjin+$item['auction_price'];?>
总价：<span class="f_red f_b px16" id="total_amount" style="display:none"><?php echo $item['auction_price'];?></span><span class="f_red f_b px16"><?php echo $totol;?>=<?php echo $item['auction_price'];?>+<?php echo ($yongjin);?>(佣金)</span> 元</div>
</div>
<div class="b10">&nbsp;</div>
