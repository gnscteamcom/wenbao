...
<td>&nbsp;<a href="favorite.php?typeid=<?php echo $v['typeid'];?>"><?php echo $v['type'];?></a>&nbsp;</td>
...
<td>
<a href="favorite.php?action=edit&itemid=<?php echo $v['itemid'];?>"><img width="16" height="16" src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/edit.png" title="修改" alt=""/></a>&nbsp;
