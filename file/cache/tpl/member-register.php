...
<td height="35">
<input type="hidden" name="post[regid]" value="6" id="g_6" onclick="reg(1);" /><label for="g_6"> <?php echo $GROUP['6']['groupname'];?></label>&nbsp;&nbsp;&nbsp;&nbsp;
...
>
<input type="hidden" name="post[regid]" value="5" id="g_5" onclick="reg(0);" checked/><label for="g_5"> <?php echo $GROUP['5']['groupname'];?></label>
</span>
</td>
</tr>
</table>
...
<td height="35" class="tl">电子邮箱  <span class="f_red">*</span><!--<span class="f_red">*</span>--></td>
<td height="35"><input type="text" class="reg_inp" style="width:200px;" name="post[email]" id="email" <?php if($email) { ?> value="<?php echo $email;?>" readonly<?php } ?>
/></td>
<td>
...
<td height="35" class="tl">手机号码 <span class="f_red">*</span><?php if($could_mobilecode) { ?><span class="f_red">*</span><?php } else { ?>&nbsp;<?php } ?>
</td>
