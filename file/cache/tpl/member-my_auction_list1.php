...
<div class="ls">
<form method="post" action="/auction/buyhe.php" enctype="multipart/form-data">
...
<td align="left" title="<?php echo $v['alt'];?>"><ul><li><?php if($v['status']==3) { ?><a href="/auction/<?php echo $v['linkurl'];?>" target="_blank" class="t"><?php } else { ?><a href="/auction/show.php?itemid=<?php echo $v['itemid'];?>" class="t"><?php } ?>
<?php echo $v['title'];?></a><?php if($v['status']==1 && $v['note']) { ?> <a href="javascript:" onclick="alert('<?php echo $v['note'];?>');"><img src="<?php echo DT_STATIC;?><?php echo $MODULE['2']['moduledir'];?>/image/why.gif" title="未通过原因"/></a><?php } ?>
 ...
 <?php echo $_process[$v['process']];?> (<a href="/auction/buy.php?itemid=<?php echo $v['itemid'];?>" target="_blank"><strong style="color:#CC0000">提交订单</strong></a>)</li></ul></td>
...
<td class="f_price"><?php echo $v['yunfei'];?></td>
...
<?php } } ?>
<tr>
<td><input type="submit" name="sub" value="合并订单"></td>
</tr>
</table>
</div>
