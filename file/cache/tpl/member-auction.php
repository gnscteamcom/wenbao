...
<?php } else { ?>
<input type="button" value="已完成" class="btn" onclick="if(confirm('您确定买家已经消费吗？此操作将不可撤销'))Go('auction.php?itemid=<?php echo $v['itemid'];?>&action=update&step=used&page=<?php echo $page;?>');"/>
<?php } ?>
<?php } ?>
<input type="button" value="订单详情" class="btn" onclick="Go('auction.php?itemid=<?php echo $v['itemid'];?>&action=update&step=detail');"/>
&nbsp;
