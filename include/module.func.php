...
function get_albums($item, $type = 0) {
	...
	if($type == 0) {
		...
		$imgs[] = $item['thumb5'] ? $item['thumb5'] : $nopic;
		$imgs[] = $item['thumb6'] ? $item['thumb6'] : $nopic;
		$imgs[] = $item['thumb7'] ? $item['thumb7'] : $nopic;
	} else if($type == 1) {
		...
		$imgs[] = $item['thumb3'] ? str_replace('.thumb.', '.middle.', $item['thumb3']) : $nopic;
		$imgs[] = $item['thumb4'] ? str_replace('.thumb.', '.middle.', $item['thumb4']) : $nopic;
		$imgs[] = $item['thumb5'] ? str_replace('.thumb.', '.middle.', $item['thumb5']) : $nopic;
		$imgs[] = $item['thumb6'] ? str_replace('.thumb.', '.middle.', $item['thumb6']) : $nopic;
		$imgs[] = $item['thumb7'] ? str_replace('.thumb.', '.middle.', $item['thumb7']) : $nopic;
	}
	return $imgs;
}
