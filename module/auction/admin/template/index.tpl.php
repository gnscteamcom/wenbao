...
<form action="?">
	...
	<table cellpadding="2" cellspacing="1" class="tb">
		...
		<tr>
			...
			<select name="process">
				...
				<option value="0" <?php if($process == 0) echo 'selected';?>>竞拍中</option>
				<option value="1" <?php if($process == 1) echo 'selected';?>>竞拍中</option>
	...
	<tr>
		<td>
			&nbsp;起拍价：<input type="text" size="4" name="minprice" value="<?php echo $minprice;?>"/> ~ <input type="text" size="4" name="maxprice" value="<?php echo $maxprice;?>"/>&nbsp;
			秒杀价：<input type="text" size="4" name="minmarketprice" value="<?php echo $minmarketprice;?>"/> ~ <input type="text" size="4" name="maxmarketprice" value="<?php echo $maxmarketprice;?>"/>&nbsp;
			加价幅度：<input type="text" size="4" name="minminamount" value="<?php echo $minminamount;?>"/> ~ <input type="text" size="4" name="maxminamount" value="<?php echo $maxminamount;?>"/>&nbsp;
			<!-- 人数：<input type="text" size="4" name="minamount" value="<?php echo $minamount;?>"/> ~ <input type="text" size="4" name="maxamount" value="<?php echo $maxamount;?>"/>&nbsp; -->
...
<form method="post">
	...
	<table cellpadding="2" cellspacing="1" class="tb">
		...
		<tr onmouseover="this.className='on';" onmouseout="this.className='';" align="center">
			...
			<td class="px11"><?php echo $v['marketprice'];?></td>
