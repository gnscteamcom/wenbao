...
<td><?php echo group_checkbox('setting[auction_index][]', $auction_index);?></td>
</tr>
<tr>
<td class="tl">允许浏览分类列表</td>
<td><?php echo group_checkbox('setting[auction_list][]', $auction_list);?></td>
</tr>
<tr>
<td class="tl">允许浏览信息内容</td>
<td><?php echo group_checkbox('setting[auction_show][]', $auction_show);?></td>
</tr>
<tr>
<td class="tl">允许浏览联系方式</td>
<td><?php echo group_checkbox('setting[auction_contact][]', $auction_contact);?></td>
</tr>
<tr>
<td class="tl">允许搜索信息</td>
<td><?php echo group_checkbox('setting[auction_search][]', $auction_search);?></td>
</tr>
<tr>
<td class="tl">允许设置标题颜色</td>
<td><?php echo group_checkbox('setting[auction_color][]', $auction_color);?></td>
</tr>
<tr>
<td class="tl">刷新信息不扣积分</td>
<td><?php echo group_checkbox('setting[auction_refresh][]', $auction_refresh);?></td>
</tr>
<tr>
